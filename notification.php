<?php
	function GetAllAlert()
	{
		...
		try 
		{
			...
			$sth = $db->prepare("SELECT * FROM `confrence_request` WHERE isaccepted = 0;");
			$sth->execute();
			$result = $sth->fetchAll();
...
<html lang="en">
  <head>
    ...
    <title>L-earn | Notification</title>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel tile">
                <div class="x_title">
                  <h2>Request for Confrence Session</h2>
                ...
                <div class="x_content">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<?php if(isset($alertArray) && count($alertArray) > 0) { ?>
						<table class="table">
						  <thead>
							<tr>
							  <th>#</th>
						  ...
						  <tbody>
							...
							<?php foreach ($alertArray as $rowIndex => $rowItem) { ?>
							<tr>
							  <th scope="row"><?php echo $rowIndex + 1;?></th>
							  <td><?php echo $rowItem['requested_by'];?></td>
							  <td><?php echo $rowItem['topic'];?></td>
							  <td><?php echo $rowItem['request_date'];?></td>
							  <td><a class="btn btn-success" href="skype:lance.teoh?call"><i class="fa fa-phone"></i> ANSWER</a></td>
							</tr>
