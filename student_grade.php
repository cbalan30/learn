			...
			<div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>Wanton Cooking </p>
                            </td>
                            <td>30%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>DIY Plumbing </p>
                            </td>
                            <td>10%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>House Painting </p>
                            </td>
                            <td>20%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>Bycycle Repairing </p>
                            </td>
                            <td>15%</td>
                          </tr>
                          <tr>
						...
						<ul class="list-unstyled top_profiles scroll-view">
                          <li class="media event">
                            ...
                            <div class="media-body">
                              ...
                              <p><strong>Excelent </strong> student. Able to learn fast. </p>
                              <p> <small>9AM Today</small>
                              </p>
                            </div>
                          </li>
                          <li class="media event">
                            ...
                            <div class="media-body">
                              <a class="title" href="#">Mr. Antoine Griezmann</a>
                              <p>Easy to deal with. <strong>Brilliant</strong></p>
                              <p> <small>2 weeks ago</small>
                              </p>
                            </div>
                          </li>
                          <li class="media event">
                            ...
                            <div class="media-body">
                              <a class="title" href="#">Mr. Sebastian Vettel</a>
                              <p><strong>Quick Learner</strong>. </p>
                              <p> <small>about a month ago</small>
                              </p>
                            </div>
                          </li>
                  ...
                  <div class="x_content">
                      <div class="row">
                        <div class="progress_title">
                          <span class="left">Peter Parker</span>
                          <span class="right">Wanton</span>
                          <div class="clearfix"></div>
                        </div>
                      ...
                      <div class="row">
                        <div class="progress_title">
                          <span class="left">Johnny Depp</span>
                      ...
                      <div class="row">
                        <div class="progress_title">
                          <span class="left">Steve Bruce</span>
                          <span class="right">Cycling</span>
                          <div class="clearfix"></div>
                        </div>
                        <div class="col-xs-10">
                          <div class="progress progress_sm">
			  ...
			  <div class="col-md-4 col-sm-6 col-xs-12 widget_tally_box">
                ...
                <div class="x_panel fixed_height_320">
                  ...
                  <div class="x_content">
                    <div class="dashboard-widget-content">
                        <canvas width="200" height="120" id="chart_gauge_01" class="" style="width: 210px; height: 140px;"></canvas>
